  ...
  if(received_bits == 32){
    ...
    if(command == (uint8_t)(~neg_command)){
      ...
      switch(command){
        ...
        //case BUTTON_5: printf("BUTTON_5, command: %u\n", command); current_effect = None; all_layers_low(); TIMSK2 |= _BV(TOIE2); break;
        case BUTTON_6: printf("BUTTON_6, command: %u\n", command); current_effect = Effect_4; break;
